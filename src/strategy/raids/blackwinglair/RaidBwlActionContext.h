...
public:
    RaidBwlActionContext()
    {
        ...
        creators["bwl check fearward aura"] = &RaidBwlActionContext::bwl_check_fearward_aura;
...
private:
    ...
    static Action* bwl_check_fearward_aura(PlayerbotAI* botAI) { return new BwlFearwardAuraCheckAction(botAI); }
