...
public:
    RaidStrategyContext() : NamedObjectContext<Strategy>(false, true)
    {
        ...
        creators["serpentshrinecavern"] = &RaidStrategyContext::serpentshrinecavern;
    }
...
private:
    ...
    static Strategy* serpentshrinecavern(PlayerbotAI* botAI) { return new RaidSerpentShrineCavernStrategy(botAI); }
};
